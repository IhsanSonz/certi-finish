...
Route::group(['prefix' => 'participant', 'as' => 'participant.'], function () {
    ...
    Route::get('/{id}/edit', [Controllers\ParticipantController::class, 'edit'])->name('edit'); // Mengubah URL menjadi '/{id}/edit'
    Route::put('/{id}', [Controllers\ParticipantController::class, 'update'])->name('update'); // Mengubah URL menjadi '/{id}'
});
